...
public class AddCandidiateController {

    @FXML
    private TextField CNIC_text1;
    ...
    String CurrentPage= "AddCandidiate.fxml";
    String file;
    int Setid=-1;
    ...
    @FXML
    void AddCandidiateAction(ActionEvent event) {
		...
		Candidiate p= new Candidiate(Setid,PartyName);
		boolean con = p.AddCondidate();
		if(con) {
    		showDialog("Candidiate added Sucessfully");
    		return;
    ...
    void SelectSymbol(ActionEvent event ) {
    	...
    	if (result.isPresent()){
    		...
    		showDialog("Please Allocate a Symbol to the Candidate");
    	}	
    }
